// zlog is a JSON-structured logging implementation of the slog.Handler interface.
// Which provides the ability to print stacktrace, a development mode that renders logs
